...
SELECT tb_produtos.id, tb_produtos.nome, tb_produtos.preco, tb_produtos.quantidade_estoque, tb_produtos.marca, tb_categorias.nome
FROM tb_produtos
...
FROM tb_produtos
INNER JOIN tb_categorias ON tb_produtos.id_categoria = tb_categorias.id
WHERE tb_categorias.nome = 'Acabamento';
